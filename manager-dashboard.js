(() => {
  ...
  const el = {
    ...
    managerGlobalSearchForm: document.getElementById('manager-global-search-form'),
    managerGlobalSearch: document.getElementById('manager-global-search'),
    managerGlobalSearchStatus: document.getElementById('manager-global-search-status'),
    managerRailToggle: document.getElementById('manager-rail-toggle'),
    managerQuickAccessNav: document.getElementById('manager-quick-access-nav'),
    managerCardPanels: Array.from(document.querySelectorAll('[data-manager-card-panel]')),
    managerCardLinks: Array.from(document.querySelectorAll('[data-manager-card-link]')),
    managerCardJumpButtons: Array.from(document.querySelectorAll('[data-manager-card-jump]')),
    managerCardFocusButtons: Array.from(document.querySelectorAll('[data-manager-card-focus]')),
    managerSubcardLinks: Array.from(document.querySelectorAll('[data-manager-subcard-link]')),
    managerInboxPanels: Array.from(document.querySelectorAll('[data-manager-inbox-panel]')),
    ...
    managerOverviewActiveProjects: document.getElementById('manager-overview-active-projects'),
    managerOverviewOpenQuotes: document.getElementById('manager-overview-open-quotes'),
    managerOverviewEstimates: document.getElementById('manager-overview-estimates'),
    ...
    projectsFilterStage: document.getElementById('projects-filter-stage'),
    projectsFilterClient: document.getElementById('projects-filter-client'),
    projectsFilterOwner: document.getElementById('projects-filter-owner'),
    ...
    quotesFilterWorkflowStatus: document.getElementById('quotes-filter-workflow-status'),
    quotesFilterPriority: document.getElementById('quotes-filter-priority'),
    quotesFilterProjectType: document.getElementById('quotes-filter-project-type'),
    ...
    clientsFilterLifecycle: document.getElementById('clients-filter-lifecycle'),
    clientsRefresh: document.getElementById('clients-refresh-btn'),
    clientsList: document.getElementById('clients-list'),
    staffFilterQ: document.getElementById('staff-filter-q'),
    staffFilterRole: document.getElementById('staff-filter-role'),
  ...
  const requiredRefs = [
    ...
    'seedBtn',
    'seedStatus',
    'managerCompanyEventsList',
    'managerMailboxPrivateCount',
    'managerMailboxProjectCount',
    'managerMailboxPrivatePreview',
    'managerMailboxProjectPreview',
    'managerAvailableOptions',
    'projectCreateForm',
    'projectsList',
    'projectEditForm',
    'quotesList',
    ...
    'estimateUpdateForm',
    'estimateLineForm',
    'managerDirectThreadsList',
    'managerDirectThreadForm',
    'managerGroupThreadsList',
    'managerGroupThreadForm',
    'managerQuickAccessNav',
    'managerGlobalSearchForm'
  ];

  if (requiredRefs.some((key) => !el[key])) return;
  ...
  const state = {
    ...
    activeManagerCard: 'overview',
    activeManagerSubcard: 'private',
    projectsQuery: {
      page: 1,
    ...
    quotesQuery: { page: 1, pageSize: DEFAULT_PAGE_SIZE, q: '', status: '', workflowStatus: '', priority: '', projectType: '' },
    ...
    clientsQuery: { q: '', crmLifecycleStatus: '' },
    staffQuery: { q: '', role: '' },
    lazyLoaded: {
      quotes: false,
      services: false,
