const shared = {
  ...
  heroPrimaryChip: 'Six studio service lines',
  heroSecondaryChip: 'Private consultation first',
  contactLead:
    'The same direct studio numbers and email shown on the business card are surfaced here so local enquiries can move directly into a private consultation.',
  serviceLinks: [
  ...
  studioLinks: [
    ...
    { href: '/index.html#areas', label: 'Coverage' },
