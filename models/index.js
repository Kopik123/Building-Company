...
const ensureIndexes = async () => {
  ...
  const indexSpecs = [
    ...
    { table: Quote.getTableName(), name: 'quotes_visit_status_date_idx', fields: ['siteVisitStatus', 'siteVisitDate'] },
    { table: Quote.getTableName(), name: 'quotes_client_decision_idx', fields: ['clientDecisionStatus', 'updatedAt'] },
    { table: Quote.getTableName(), name: 'quotes_client_review_started_idx', fields: ['clientReviewStartedAt', 'updatedAt'] },
    ...
    { table: Estimate.getTableName(), name: 'estimates_client_visible_status_idx', fields: ['clientVisible', 'status'] },
    { table: Estimate.getTableName(), name: 'estimates_revision_number_idx', fields: ['quoteId', 'revisionNumber'] },
