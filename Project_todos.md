...
- [ ] Local `npm run migrate:status` still hard-fails without `DATABASE_URL`; decide whether to document that requirement more clearly or add a safe local fallback/dev bootstrap for migration tooling.
