...
- [ ] Continue splitting `manager-dashboard.js` into feature modules: `estimates`, `messages` after the `projects`, `quotes`, `services`, `materials`, `clients` and `staff` domain extraction.
