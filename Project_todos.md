...
- [ ] Continue splitting `manager-dashboard.js` into feature modules: `services`, `materials`, `clients`, `staff`, `estimates`, `messages` after the `projects` and `quotes` domain extraction.
