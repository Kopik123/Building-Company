...
- [ ] Continue the `web-v2` refactor after the page-level split by extracting shared domain hooks and breaking the still-large `quotes`, `crm`, `inventory` and `private-inbox` pages into smaller list/detail/editor submodules.
