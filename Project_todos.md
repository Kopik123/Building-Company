...
- [ ] Continue splitting `manager-dashboard.js` into feature modules: `clients`, `staff`, `estimates`, `messages` after the `projects`, `quotes`, `services` and `materials` domain extraction.
