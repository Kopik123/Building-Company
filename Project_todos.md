...
- [ ] Continue the `web-v2` refactor by extracting smaller list/detail/editor modules and typed view-model adapters from `quotes`, `crm`, `private-inbox` and `inventory` now that the page-level prop surfaces are narrower.
