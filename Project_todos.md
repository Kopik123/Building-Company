...
- [ ] Continue the `web-v2` refactor after the first domain-hook extraction by breaking the still-large `quotes`, `crm`, `inventory` and `private-inbox` pages into smaller list/detail/editor submodules and trimming their page-level import breadth.
